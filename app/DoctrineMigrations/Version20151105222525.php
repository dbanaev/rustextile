 ...
 */
class Version20151105222525 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE sip_media_gallery_has_media DROP media_id, DROP gallery_id');
        $this->addSql('DROP INDEX IDX_DF10FA6F12469DE2 ON sip_media_gallery_media');
        $this->addSql('ALTER TABLE sip_media_gallery_media DROP category_id, DROP cdn_flush_identifier');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE content_classification_category (id INT AUTO_INCREMENT NOT NULL, media_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, context INT DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, enabled TINYINT(1) NOT NULL, slug VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, description VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci, position INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_C52BCF7727ACA70 (parent_id), INDEX IDX_C52BCF7E25D857E (context), INDEX IDX_C52BCF7EA9FDD75 (media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE content_classification_collection (id INT AUTO_INCREMENT NOT NULL, media_id INT DEFAULT NULL, context INT DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, enabled TINYINT(1) NOT NULL, slug VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, description VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX tag_collection (slug, context), INDEX IDX_D3EDA93EE25D857E (context), INDEX IDX_D3EDA93EEA9FDD75 (media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE content_classification_context (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, enabled TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE content_classification_tag (id INT AUTO_INCREMENT NOT NULL, context INT DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, enabled TINYINT(1) NOT NULL, slug VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX tag_context (slug, context), INDEX IDX_94FAD39E25D857E (context), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE sip_media_gallery_has_media ADD media_id INT DEFAULT NULL, ADD gallery_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE sip_media_gallery_media ADD category_id INT DEFAULT NULL, ADD cdn_flush_identifier VARCHAR(64) DEFAULT NULL COLLATE utf8_unicode_ci');
        ...
        $this->addSql('ALTER TABLE sip_user_user CHANGE biography biography VARCHAR(1000) DEFAULT NULL COLLATE utf8_unicode_ci');
    }
}

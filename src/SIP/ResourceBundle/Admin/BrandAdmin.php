...
use SIP\ResourceBundle\Entity\Brand;
use SIP\ResourceBundle\Entity\Media\Media;
use SIP\ResourceBundle\Entity\Media\BrandHasMedia;
...
class BrandAdmin extends Admin
{
            ...
            ->tab('General')
                ...
                ->with('Gallery')
                    ...
                    ->add('gallery', 'sonata_type_collection', array(
                            ...
                            'inline'       => 'table',
                            'sortable'     => 'position',
                            'admin_code'   => 'sip.resource.brandhasmedia.admin',
                        )
                    )
                ->end()
            ->end()
     ...
     * @return mixed
     */
    public function generateSiteUrl(Brand $object)
    {
        return $this->container->get('router')->generate('sip_resource_brand', array('slug' => $object->getSlug()));
    }
}
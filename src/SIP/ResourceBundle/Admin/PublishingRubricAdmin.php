...
class PublishingRubricAdmin extends Admin
{
    /**
     * @var int
     */
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        $formMapper
            ->with('General')
            ->add('name', null, array('label' => 'sip_publishing_rubric_name'))
            ->end()
        ;
    }
    ...
    {
        $listMapper
            ->addIdentifier('name', null, array('label' => 'sip_publishing_rubric_name'))
